...
function ArticleByID() {
  ...
  useEffect(() => {
    ...
    const getArticle = async () => {
      ...
      try {
        const res = await axios.get(API_ENDPOINTS.USER_ARTICLE_BY_ID(id), { withCredentials: true });
  ...
  const addComment = async (commentObj) => {
    ...
    let res = await axios.put(API_ENDPOINTS.USER_ADD_COMMENT, commentObj, { withCredentials: true });
    if (res.status === 200) {
